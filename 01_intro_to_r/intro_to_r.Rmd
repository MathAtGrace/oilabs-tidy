...
5.  In your lab report, use complete sentence(s) to tell me when you need to intall packages and when you need to load packages with the `library` function.

6.  In your lab report, use complete sentence(s) to tell me the three ways to view data.
