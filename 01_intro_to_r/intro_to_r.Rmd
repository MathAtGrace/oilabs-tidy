...
```{r why_R, results=TRUE, echo=FALSE}
embed_url("https://www.youtube.com/watch?v=lNWVQ2oxNho")
```

```{r how-to-lab, results=TRUE, echo=FALSE}
embed_url("https://youtu.be/SXFYz5sNnbE")
```
...
```{r hidden-total, echo= FALSE, eval=TRUE}
present <- present %>%
  mutate(total = boys + girls)
```
