...
But we need to refocus and get back to our chi-squared test.  We can run a chi-squared test on this data by creating a two-way table and then passing it to the function `chisq.test()`.
